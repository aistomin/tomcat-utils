...
/**
 * Mock bash implementation.
 *
 * @author Andrei Istomin (andrej.istomin.ikeen@gmail.com)
 * @version $Id$
 * @since 0.1
 */
public final class MockBash implements Bash {

    /**
     * Execute bash command synchronously.
     * @param cmd Bash command that needs to be executed.
     * @return Exit code.
     * @todo: Let's implement this method and solve issue #26.
     */
     ...
     * @param cmd Bash command that needs to be executed.
     * @return Exit code.
     * @todo: Let's implement this method and solve issue #27.
     */
